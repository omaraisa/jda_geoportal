...
const SymbologyManager: React.FC = () => {
  ...
  return (
    <div className="p-4 flex flex-col gap-4">
      <h2 className="text-lg font-bold">{t("widgets.symbology.title")}</h2>
      
      <div className="flex flex-col gap-2">
        <label className="text-sm font-medium">{t("widgets.symbology.selectLayer")}</label>
        <LayerSelector 
      ...
      {selectedLayer && (
        <>
          ...
          <Button 
            ...
            disabled={!selectedLayer || (rendererType !== "simple" && !selectedFields.some(f => f !== ""))}
          >
