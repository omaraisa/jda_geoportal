    ...
    >
      <div className="flex items-center justify-between mx-2">
        ...
        <div className="flex items-center gap-2">
          <calcite-icon icon={layer.visible ? "view-visible" : "view-hide"} scale="s" className="cursor-pointer" onClick={() => toggleLayerVisibility(layer,setLayers)} />
          <calcite-icon icon="handle-vertical" scale="s" className="cursor-pointer" onClick={() => handleOptionsClick(layer.id, activeLayerId, setactiveLayerId, setLayers)} />
          <calcite-icon icon="trash" scale="s" className="cursor-pointer" onClick={() => handleRemoveLayer(layer, setLayers)} />
        </div>
      </div>
